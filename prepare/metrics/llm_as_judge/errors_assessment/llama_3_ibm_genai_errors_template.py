...
template = "templates.response_assessment.errors_assessment.table2text_single_turn_without_reference"
task = ""  # TODO: create a new task?
...
for model_id in model_list:
    ...
    add_to_catalog(
        metric,
        f"metrics.llm_as_judge.errors_assessment.{model_label}_template_{template_label}",
        overwrite=True,
    )
