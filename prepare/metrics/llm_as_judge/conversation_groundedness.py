...
ensemble_metric = RandomForestMetricsEnsemble(
    metrics=metric_lst,
    weights=weights,
    __description__="A pre-trained Random Forest-based ensemble judge to assesss multi-turn conversation quality on answer groundedness: Every substantial claim in the response of the model is derivable from the content of the document.",
)
