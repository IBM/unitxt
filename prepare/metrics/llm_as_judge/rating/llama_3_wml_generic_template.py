...
metric = LLMAsJudge(
    ...
    main_score="llama_3_70b_instruct_wml_template_generic_single_turn",
    prediction_type=str,
)
...
metric = LLMAsJudge(
    ...
    main_score="llama_3_70b_instruct_wml_template_generic_single_turn_with_reference",
)

add_to_catalog(
    metric,
    "metrics.llm_as_judge.rating.llama_3_70b_instruct_wml_template_generic_single_turn_with_reference",
    overwrite=True,
)
