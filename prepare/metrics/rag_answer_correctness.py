...
recall_instance_targets = [
    ...
    {"f1": 0.33, "precision": 0.33, "recall": 0.33, "score": 0.33, "score_name": "f1"},
]
...
for catalog_name, global_target, instance_targets in [
    ("metrics.rag.answer_correctness", recall_global_target, recall_instance_targets),
    ("metrics.rag.recall", recall_global_target, recall_instance_targets),
]:
    test_answer_correctness(task_data, catalog_name, global_target, instance_targets)
