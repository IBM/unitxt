...
from unitxt.struct_data_operators import SerializeTableAsDFLoader, ShuffleTableRows
...
add_to_catalog(card, "cards.numeric_nlg__df__shuffle_rows", overwrite=True)
