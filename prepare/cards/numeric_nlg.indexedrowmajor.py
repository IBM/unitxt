...
from unitxt.struct_data_operators import SerializeTableAsIndexedRowMajor
...
card = TaskCard(
    ...
    preprocess_steps=[
        ...
        SerializeTableAsIndexedRowMajor(field="table_out", to_field="input_a"),
...
add_to_catalog(card, "cards.numeric_nlg__indexedrowmajor", overwrite=True)
