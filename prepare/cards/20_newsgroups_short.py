...
from unitxt.operators import FilterByCondition, FilterByExpression
...
card = TaskCard(
    ...
    preprocess_steps=[
        ...
        ),  # 543.44 is within the 95% quantile
        SplitRandomMix(
...
add_to_catalog(artifact=card, name=f"cards.{dataset_name}_short", overwrite=True)
