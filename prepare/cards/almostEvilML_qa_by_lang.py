...
from src.unitxt.operators import Apply, CopyFields, FilterByValues, RemoveFields
...
for lang in langs:
    ...
    card = TaskCard(
        ...
        preprocess_steps=[
            ...
            CopyFields(field_to_field=[("metadata/language", "extracted_language")], use_query=True),
