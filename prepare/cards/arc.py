...
for subtask in subtasks:
    card = TaskCard(
        ...
        preprocess_steps=[
            ...
            CopyFields(field_to_field={"_choices/text": "choices", "_choices/label": "labels"}, use_query=True),
    ...
    test_card(card)
    add_to_catalog(card, f'cards.ai2_arc.{subtask.replace("-", "_").lower()}', overwrite=True)
