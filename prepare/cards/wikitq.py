...
card = TaskCard(
    ...
    __description__="The WikiTableQuestions (Wiki Table Questions) dataset is a large-scale dataset for the task of question answering on semi-structured tables.",
    __tags__={
        "modality": "table",
