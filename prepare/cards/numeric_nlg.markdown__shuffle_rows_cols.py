...
from unitxt.struct_data_operators import ShuffleTableColumns, ShuffleTableRows
...
add_to_catalog(card, "cards.numeric_nlg__markdown__shuffle_rows_cols", overwrite=True)
