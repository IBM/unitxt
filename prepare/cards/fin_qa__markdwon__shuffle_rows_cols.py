...
card = TaskCard(
    ...
    preprocess_steps=[
        ...
        ShuffleTableRows(field="stdtable"),
        ShuffleTableColumns(field="stdtable"),
        SerializeTableAsMarkdown(field="stdtable", to_field="serialized_table"),
    ],
    task=Task(
        inputs={
            "pre_text": str,
...
add_to_catalog(card, "cards.fin_qa__markdown__shuffle_rows_cols", overwrite=True)
