...
from unitxt.struct_data_operators import SerializeTableAsJson
...
card = TaskCard(
    ...
    preprocess_steps=[
        SerializeTableAsJson(field_to_field=[["table", "table_serialized"]]),
...
test_card(card)
add_to_catalog(card, "cards.tab_fact__json", overwrite=True)
