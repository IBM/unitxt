...
from unitxt.struct_data_operators import MapTableListsToStdTableJSON, ShuffleTableRows
...
add_to_catalog(card, "cards.fin_qa__indexedrowmajor__shuffle_rows", overwrite=True)
