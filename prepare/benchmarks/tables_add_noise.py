...
from unitxt.inference import (
    NoiseHFAutoModelInferenceEngine,
)
from unitxt.settings_utils import get_settings
from unitxt.standard import DatasetRecipe

# usage: python prepare/benchmarks/tables_add_noise.py [-out_path OUT_PATH] [-models MODELS] [-cards CARDS]
    ...
    with settings.context(
        ...
        for model in models_parsed:
            ...
            for subset_name, subset in tqdm(subsets.items(), desc="Running..."):
                ...
                inference_model = NoiseHFAutoModelInferenceEngine(
