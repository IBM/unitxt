...
n one line of code, it prepares a dataset or mixtures-of-datasets into an sequence to sequence input-output format for training and evaluation. Our aspiration is to be simple, adaptable, and transparent.
