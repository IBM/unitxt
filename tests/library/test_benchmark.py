            ...
            [
                {
                    ...
                    "task_data": '{"text": "The sailors rode the breeze clear of the rocks.", "text_type": "text", "classes": ["unacceptable", "acceptable"], "type_of_class": "grammatical acceptability", "metadata": {"data_classification_policy": ["public"], "template": "templates.classification.multi_class.instruction", "num_demos": 0}, "label": "acceptable"}',
                    "groups": [],
                    "media": {"audios": [], "images": []},
                    "subset": ["cola"],
                },
                {
                    ...
                    "task_data": '{"text": "The weights made the rope stretch over the pulley.", "text_type": "text", "classes": ["unacceptable", "acceptable"], "type_of_class": "grammatical acceptability", "metadata": {"data_classification_policy": ["public"], "template": "templates.classification.multi_class.instruction", "num_demos": 0}, "label": "acceptable"}',
                    "groups": [],
                    "media": {"audios": [], "images": []},
                    "subset": ["cola"],
                },
