...
class TestMetrics(UnitxtTestCase):
    ...
    def test_tool_calling_metric(self):
        ...
        self.assertEqual(outputs[0]["score"]["global"]["tool_choice_accuracy"], 1.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_recall"], 1.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_precision"], 1.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_value_precision"], 1.0)
        ...
        self.assertEqual(outputs[0]["score"]["global"]["tool_choice_accuracy"], 0.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_recall"], 1.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_precision"], 1.0)
        # Test case 3: Different parameter names
        prediction = {"name": "test_tool", "arguments": {"param1": "value1", "wrongParam": "value2"}}
        reference = {"name": "test_tool", "arguments": {"param1": "value1", "param2": 42, "param3": 24}}
        ...
        self.assertEqual(outputs[0]["score"]["global"]["exact_match"], 0.0)
        self.assertEqual(outputs[0]["score"]["global"]["tool_choice_accuracy"], 1.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_recall"], 1/3)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_precision"], 0.5)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_value_precision"], 0.5)
        ...
        # Recall should be 0 and precision 1 for empty arguments
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_recall"], 0.0)
        self.assertEqual(outputs[0]["score"]["global"]["parameter_name_precision"], 1.0)
        ...
        self.assertEqual(outputs[0]["score"]["global"]["parameter_schema_validation"], 1.0)
        ...
        self.assertEqual(outputs[0]["score"]["global"]["parameter_schema_validation"], 0.0)
